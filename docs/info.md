...
•	Digital Sensors:
o	HC-SR501 PIR Motion Sensor (for Motion_Sensor)
o	MC-38 Magnetic Reed Switch (for Door_Sensor and Window_Sensor)
•	Control Inputs:
o	Mini Toggle Switch (for Armed_Input)
o	12mm Momentary Tactile Pushbutton (for Manual_Reset)
•	Display:
o	A VGA-compatible monitor connected to the uo_out pins.
How to Test
...
<img width="468" height="652" alt="image" src="https://github.com/user-attachments/assets/e3e57f2a-5274-4b9a-9d0a-d59550ce7028" />
